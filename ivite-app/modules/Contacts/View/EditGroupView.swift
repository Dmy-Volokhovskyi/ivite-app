...
final class EditGroupView: BaseView {
    private let groupNameHeader: IVHeaderLabel = .init(text: "Edit group")
    ...
    init(contacts: [ContactCardModel], group: ContactGroup) {
    ...
    @objc private func didTouchSaveButton(_ sender: UIButton) {
        delegate?.didEditGroup(group, contacts: contacts)
    }
...
extension EditGroupView: UITableViewDataSource {
...
extension EditGroupView: UITableViewDelegate {
...
extension EditGroupView: IVTextFieldDelegate {
