...
final class EventDetailsBuilder: BaseBuilder {
    func make(eventDetailsDelegate: EventDetailsDelegate, eventDetailsViewModel: EventDetailsViewModel) -> EventDetailsController {
        let router = EventDetailsRouter()
        let interactor = EventDetailsInteractor(eventDetailsViewModel: eventDetailsViewModel, eventDetailsDelegate: eventDetailsDelegate,
